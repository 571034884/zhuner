...
public class SearchPageActivitycopy extends BaseActivity {
        ...
        svSearch.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                if (!TextUtils.equals(searchInput, "")) {
                    ...
                    searchResultFragment.refreshSearchList(SearchPageActivitycopy.this, searchInput, getIntent().getStringExtra("cnCityName"), page, pageSize);
...
//                    OkGoUtil.<FuzzyQueryBean>get(SearchPageActivity.this, Constans.METHOD_GET_MSG, map, FuzzyQueryBean.class, 1, SearchPageActivity.this);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if (ev.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (hideInputResult) {
                v.clearFocus();
                InputMethodManager imm = (InputMethodManager) SearchPageActivitycopy.this.getSystemService(Activity.INPUT_METHOD_SERVICE);
                if (v != null) {
                    if (imm.isActive()) {
