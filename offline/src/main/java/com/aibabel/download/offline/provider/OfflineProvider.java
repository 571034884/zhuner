package com.aibabel.download.offline.provider;
...
public class OfflineProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        if (selectionArgs != null) {
             cursor = db.query("offline_lan_list", null, "lan_code=?", selectionArgs, null, null, null, null);

        } else {
             cursor = db.query("offline_lan_list", null, "lan_code!=? or lan_code!=?", new String[]{"mdd","jqdl"}, null, null, null, null);
