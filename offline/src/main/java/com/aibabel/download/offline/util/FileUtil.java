        ...
        try {
            if(str!=null){
                if(str.endsWith("KB"))
                    ...
                    size = (long)(Double.parseDouble(str.substring(0,str.length()-2))*1024*1024);

                else if(str.endsWith("GB"))
                    size = (long)(Double.parseDouble(str.substring(0,str.length()-2))*1024*1024*1024);
            }
        } catch (Exception e) {
            L.e("sizeFormatString2Num======"+e.getMessage());
        }
