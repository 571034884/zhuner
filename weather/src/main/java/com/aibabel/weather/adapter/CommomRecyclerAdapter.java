...
public abstract class CommomRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommomRecyclerAdapter(Context mContext, T mData, List<T> mDatas, int mLayoutId,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        RecyclerView.ViewHolder viewHolder = CommonRecyclerViewHolder.getViewHolder(mContext,
                parent, mLayoutId, itemClickListener, itemLongClickListener);
        return viewHolder;
    }
    ...
    public int getItemCount() {
        if (mDatas != null)
            return mDatas.size() > 24 ? 24 + 1 : mDatas.size() + 1;
        else {
            return 0;
        }
    }
