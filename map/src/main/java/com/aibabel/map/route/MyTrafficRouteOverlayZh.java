 ...
 */
public class MyTrafficRouteOverlayZh extends OverlayManager {

    private RoutesZhBean routes = null;
    boolean focus = false;
    private LatLng origin;
    private LatLng destination;
    int typeRoute;

    private BitmapDescriptor mRedTexture = BitmapDescriptorFactory.fromAsset("icon_road_green_arrow.png");
     ...
     */
    public MyTrafficRouteOverlayZh(BaiduMap baiduMap) {
        super(baiduMap);
    }
    ...
    public final List<OverlayOptions> getOverlayOptions() {
        ...
        List<StepsZhBean> steps = routes.getSteps();
...
//        }
     ...
     *            路线数据
     */
    public void setData(RoutesZhBean routes, String origin, String destination,int typeRoute) {
