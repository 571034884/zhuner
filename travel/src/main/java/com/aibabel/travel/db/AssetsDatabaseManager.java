...
import com.aibabel.travel.activity.BaseActivity;
...
public class AssetsDatabaseManager {
    ...
    private static String packageName = CommonUtils.getCurrentPkgName(BaseApplication.CONTEXT);
    private static String databasepath = "/data/data/"+packageName+"/database"; // %s is packageName
