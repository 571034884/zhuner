package com.aibabel.travel.widgets.recycleview;
...
//        pb_header_refresh = (ProgressBar) headerView.findViewById(R.id.pb_header_refresh);
        ...
        tv_englishName = (TextView) headerView.findViewById(R.id.tv_englishName);
        tv_name = (TextView) headerView.findViewById(R.id.tv_name);
        iv_play = (ImageView) headerView.findViewById(R.id.iv_play);
        rl_place = (RelativeLayout) headerView.findViewById(R.id.rl_place);
