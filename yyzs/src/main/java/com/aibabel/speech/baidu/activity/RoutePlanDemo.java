package com.aibabel.speech.baidu.activity;

import java.util.List;

import com.aibabel.speech.baidu.util.MassTransitRouteOverlay;
...
import com.aibabel.speech.baidu.util.BikingRouteOverlay;
import com.aibabel.speech.baidu.util.DrivingRouteOverlay;
import com.aibabel.speech.baidu.util.MassTransitRouteOverlay;
import com.aibabel.speech.baidu.util.OverlayManager;
import com.aibabel.speech.baidu.util.TransitRouteOverlay;
import com.aibabel.speech.baidu.util.WalkingRouteOverlay;
...
public class RoutePlanDemo extends Activity implements BaiduMap.OnMapClickListener,
    ...
    String startNodeStr = "北京大学";
    String endNodeStr = "清华大学";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlanNode stNode = PlanNode.withCityNameAndPlaceName(BdMap.getInstance().getCity(RoutePlanDemo.this), getIntent().getStringExtra("f"));
        PlanNode enNode = PlanNode.withCityNameAndPlaceName(BdMap.getInstance().getCity(RoutePlanDemo.this),getIntent().getStringExtra("t"));
        mSearch.drivingSearch((new DrivingRoutePlanOption())
                .from(stNode).to(enNode));
        nowSearchType = 1;

        imgbtn_return=findViewById(R.id.routeplan_left_return);
