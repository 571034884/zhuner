...
public class DensityHelper {
    ...
    /**
     * 重新计算displayMetrics.xhdpi, 使单位px对应160重定义为设计稿的相对长度
     * 重新计算displayMetrics.xhdpi, 使单位px对应 72重定义为设计稿的相对长度
     *
     * @param context
    ...
    private static void resetDensity(Context context, float designWidth) {
        ...
        context.getResources().getDisplayMetrics().xdpi = size.x / designWidth * 160f;
    }
