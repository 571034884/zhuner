...
public class Subject {
    ...
    List<ObserverListener> observers = new ArrayList<ObserverListener>();
     ...
     * @return observers.
     */
    public List<ObserverListener> observerList() {
        return observers;
    }
     ...
     * @param observer
     */
    public synchronized void deleteObserver(ObserverListener observer) {
    ...
    public void notifyObservers(String name, Object data) {
            ...
            for (ObserverListener observer : observers) {
                observer.onReceiveMessage(name, data);
            }
        }
