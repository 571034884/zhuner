package com.aibabel.baselibrary.imageloader;
...
import com.aibabel.baselibrary.imageloader.interface_.BitmapCallBack;
...
public class LoaderOptions {
	...
	public int config;
//	public Bitmap.Config config = Bitmap.Config.RGB_565; //Pocasso和Glide 的枚举类型不一样 改为int代替
	...
	public LoaderOptions config(int config) {
		this.config = config;
		return this;
	}
