package com.aibabel.menu.view.sousuo;
...
public class SortAdapter extends BaseAdapter implements PinnedHeaderListView.PinnedHeaderAdapter, AbsListView.OnScrollListener {
    private List<CityListBean.DataBean.PopularAddrBean> list = null;
    private Context mContext;

    private MySectionIndexer mIndexer;
    private int mLocationPosition = -1;

    public SortAdapter(Context mContext, List<CityListBean.DataBean.PopularAddrBean> list, MySectionIndexer indexer) {
    ...
    public List<CityListBean.DataBean.PopularAddrBean> getData() {
        return this.list;
    }
    ...
    public void updateListView(List<CityListBean.DataBean.PopularAddrBean> list, MySectionIndexer indexer) {
        this.list = list;
        this.mIndexer = indexer;
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        final CityListBean.DataBean.PopularAddrBean mContent = list.get(position);
        if (view == null) {
            ...
            viewHolder.tvCountry = (TextView) view.findViewById(R.id.tv_city_name_country);
        ...
        if (position == mIndexer.getPositionForSection(section)) {
            ...
            viewHolder.tvLetter.setText(mContent.getGroupBy());
        } else {
            viewHolder.tvLetter.setVisibility(View.GONE);
        }

        viewHolder.tvTitle.setText(this.list.get(position).getCityChj());
        viewHolder.tvCountry.setText("("+this.list.get(position).getCountryChj()+")");
        return view;
