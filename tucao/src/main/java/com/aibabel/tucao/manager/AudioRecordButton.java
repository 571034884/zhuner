package com.aibabel.tucao.manager;
    ...
    public AudioRecordButton(Context context, AttributeSet attrs) {
        ...
        setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                if (count_down<3){
                    longListener.stopMedia();
                    longListener.onScrollfalse();
                    count_down++;
                    ...
                    ToastUtil.showShort(mContext,"最多支持3条语音吐槽");
                }
               return true;
            }
        });
...
//                }
    ...
    OnLongListener longListener;

    public void setOnLongListener(OnLongListener longListener) {
