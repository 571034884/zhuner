...
//public class Adapter_H extends BaseQuickAdapter<HistoryBean.DataBean.DataTourguideBean, BaseViewHolder> {
//
//
//
//    public Adapter_H(int layoutResId, @Nullable List<HistoryBean.DataBean.DataTourguideBean> data) {
...
//    }
//}
public class Adapter_H extends BaseQuickAdapter<HistoryBean, BaseViewHolder> {



    public Adapter_H(int layoutResId, @Nullable List<HistoryBean> data) {
        super(layoutResId, data);
    }
