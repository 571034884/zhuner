    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        if (CommonUtils.isFastClick()) {
            ...
            try {
                ...
                map.put("scenic_list_btn_collect_cancel_id", position);
                map.put("scenic_list_btn_collect_cancel_name", list.get(position).getName());
                ((ScenicActivity) getActivity()).addStatisticsEvent("scenic_list_btn_collect_cancel", map);
            }catch (Exception e){}
