...
public class OkHttp3Util {
    ...
    public static void doPost(String url, Map<String, Object> postparams, Callback callback) {
        ...
        for (String key : postparams.keySet()) {
            if(key!=null) {
                map.put(key, postparams.get(key));
            }
        }
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                try {
                    ...
                    context.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Log.e( "","下载成功:" + fileDir + "," + getNameFromUrl(url));
                        }
                    });
