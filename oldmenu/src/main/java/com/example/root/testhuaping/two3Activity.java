...
public class two3Activity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        tv7=(ImageView) findViewById(R.id.fanhui3);
        ...
        tv26=(Button)findViewById(R.id.jinru14);
