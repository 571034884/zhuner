...
public class threeActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        tv7=(ImageView) findViewById(R.id.fanhui31);
        ...
        tv31=(Button)findViewById(R.id.jinru31);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.jinru31:{
                cmpName=new ComponentName("com.aibabel.speech","com.aibabel.speech.MainActivity");
                break;
            }
            default:
                break;
