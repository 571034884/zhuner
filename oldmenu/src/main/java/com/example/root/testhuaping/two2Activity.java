...
public class two2Activity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        tv7=(ImageView) findViewById(R.id.fanhui2);
        ...
        tv8=(Button) findViewById(R.id.jinru13);
